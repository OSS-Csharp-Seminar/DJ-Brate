...
1. Write a free-text prompt to describe what you want - e.g. *"I just got off a long shift and need something to decompress"*
...
- [ ] Project architecture & Docker setup
- [ ] Spotify OAuth login flow
- [ ] Mood input UI (Blazor)
- [ ] Spotify Recommendations API integration
- [ ] AI mood-to-audio-features mapping
- [ ] MCP server with Spotify tools
- [ ] Playlist creation & preview playback
- [ ] User stats dashboard
- [ ] Feedback loop (liked/skipped tracks)
- [ ] Mood history charts
- [ ] Deployment
